        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <div class="container-fluid">
                    <h3 class="text-dark mb-1"><strong>Sample Test</strong></h3>
                </div>
                <div class="container">
                    <div class="card">
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-check" id="option1">
                                <input class="form-check-input" type="radio" id="formCheck-1" bind:group={$answers[Active.no]} value={1}>
                                <label class="form-check-label" for="formCheck-1">A</label>
                            </div>
                            <div class="form-check" id="option2">
                                <input class="form-check-input" type="radio" id="formCheck-2" bind:group={$answers[Active.no]} value={2}>
                                <label class="form-check-label" for="formCheck-1">B</label>
                            </div>
                            <div class="form-check" id="option3">
                                <input class="form-check-input" type="radio" id="formCheck-3" bind:group={$answers[Active.no]} value={3}>
                                <label class="form-check-label" for="formCheck-1">C</label>
                            </div>
                            <div class="form-check" id="option4">
                                <input class="form-check-input" type="radio" id="formCheck-4" bind:group={$answers[Active.no]} value={4}>
                                <label class="form-check-label" for="formCheck-1">D</label>
                            </div>
                            <div class="btn-group" role="group">
                                <button class="btn btn-primary" type="button">Mark for Review</button>
                                <button class="btn btn-primary" type="button" on:click={printAnswers}>Debug</button>
                            </div>
                        </div>
                    </div>
                    <div class="card" id="questions-list">
                        ...
                        <button class="btn btn-primary" type="button" style="margin-right:16px" on:click={()=>changeActive(question.no)}>{question.no}</button>
                        {/each}
                        </div>
                    </div>
                </div>
