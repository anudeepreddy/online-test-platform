...
<nav
  ...
  <div class="container-fluid">
    ...
    <form
      class="form-inline d-none d-sm-inline-block mr-auto ml-md-3 my-2 my-md-0
    ...
    <ul class="nav navbar-nav flex-nowrap ml-auto">
      ...
      <li class="nav-item dropdown no-arrow mx-1" role="presentation">
        <div class="nav-item dropdown no-arrow">
          ...
          <div
            class="dropdown-menu dropdown-menu-right dropdown-list
        ...
        <div class="nav-item dropdown show no-arrow">
          <a
            ...
            <span class="d-none d-lg-inline mr-2 text-gray-600 small">
              {#if $session.user}{$session.user.username}{/if}
            </span>
            <img
              alt="img"
          ...
          <div
            ...
            <a class="dropdown-item" role="presentation" href="." on:click={manageLogout}>
